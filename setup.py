...
name = 'trytonspain_account_invoice_consecutive'
download_url = 'https://bitbucket.org/trytonspain/trytond-account_invoice_consecutive'
...
setup(name=name,
    version=version,
    description='Tryton Account Invoice Consecutive Module',
